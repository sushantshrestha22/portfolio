...
const About = () => {
  ...
  return (
    <section id="about" className="min-h-screen  relative space-y-10 py-10">
      <section className="py-10  relative space-y-10 bg-card">
        {/* Stats Grid */}
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-4 text-secondary/80 leading-relaxed">
                  <p>
                    ...
                    and modern CSS frameworks. My methodology centers on
                    scalable component architecture, type-safe development
                    practices, and adherence to industry-standard design
                    patterns that ensure long-term maintainability and optimal
                    performance.
                  </p>
                  <p>
                    I bring proven expertise in delivering production-grade
                    applications, having architected enterprise-level CMS
                    platforms and complex web solutions. My collaborative
                    approach in agile environments, combined with a deep
                    understanding of user experience principles, enables me to
                    transform business requirements into intuitive,
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          {coreExpertise.map((area, index) => (
            ...
            >
              <Card
                key={index}
                className=" border-secondary/10 hover:border-secondary/20 transition-all duration-300"
              >
                <CardContent className="p-6 space-y-4">
